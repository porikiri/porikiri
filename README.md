# 👋 안녕하세요! 하드웨어와 소프트웨어를 잇는 porikiri입니다.
...
## 🛠️ About Me
- 💻 **컴퓨터 하드웨어**에 관심이 많아 직접 PC를 조립하고 트러블슈팅하는 것을 즐깁니다.
- ⚡ **전자회로(Breadboard) 설계**와 하드웨어 제어에 흥미를 느끼며 공부하고 있습니다.
- 🎯 현재 효율적인 코드를 작성하는 소프트웨어 기술과 PC 정비 관련 역량을 함께 쌓아가는 중입니다.
...
### 🔧 Hardware & Systems
<p>
  <img src="https://img.shields.io/badge/Computer%20Assembly-🔧-blue?style=flat-square"/>
  <img src="https://img.shields.io/badge/Circuit%20Design%20(Breadboard)-⚡-orange?style=flat-square"/>
...
<!-- 방문자 수 카운터 -->
<p align="right">
  <img src="https://hits.seify.com/api/page/counter.js?url=https://github.com/YOUR_GITHUB_USERNAME" alt="Hits" />
</p>
